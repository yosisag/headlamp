...
Defined in: [lib/k8s/backendTrafficPolicy.ts:98](https://github.com/Rucha0901/headlamp/blob/f19a5d7375f3a4adafc52bb2b8999455ae4eeca5/frontend/src/lib/k8s/backendTrafficPolicy.ts#L98)
...
| <a id="property-apiname"></a> `apiName` | `static` | `string` | `'xbackendtrafficpolicies'` | Name of the resource, plural, used in API | [`KubeObject`](../../KubeObject/classes/KubeObject.md).[`apiName`](../../KubeObject/classes/KubeObject.md#property-apiname) | - | [lib/k8s/backendTrafficPolicy.ts:100](https://github.com/Rucha0901/headlamp/blob/f19a5d7375f3a4adafc52bb2b8999455ae4eeca5/frontend/src/lib/k8s/backendTrafficPolicy.ts#L100) |
| <a id="property-apiversion"></a> `apiVersion` | `static` | `string`[] | `undefined` | Group and version of the resource formatted as "GROUP/VERSION", e.g. "policy.k8s.io/v1". | [`KubeObject`](../../KubeObject/classes/KubeObject.md).[`apiVersion`](../../KubeObject/classes/KubeObject.md#property-apiversion) | - | [lib/k8s/backendTrafficPolicy.ts:101](https://github.com/Rucha0901/headlamp/blob/f19a5d7375f3a4adafc52bb2b8999455ae4eeca5/frontend/src/lib/k8s/backendTrafficPolicy.ts#L101) |
| <a id="property-isnamespaced"></a> `isNamespaced` | `static` | `boolean` | `true` | Whether the object is namespaced. | [`KubeObject`](../../KubeObject/classes/KubeObject.md).[`isNamespaced`](../../KubeObject/classes/KubeObject.md#property-isnamespaced) | - | [lib/k8s/backendTrafficPolicy.ts:102](https://github.com/Rucha0901/headlamp/blob/f19a5d7375f3a4adafc52bb2b8999455ae4eeca5/frontend/src/lib/k8s/backendTrafficPolicy.ts#L102) |
...
Defined in: [lib/k8s/backendTrafficPolicy.ts:112](https://github.com/Rucha0901/headlamp/blob/f19a5d7375f3a4adafc52bb2b8999455ae4eeca5/frontend/src/lib/k8s/backendTrafficPolicy.ts#L112)
...
Defined in: [lib/k8s/backendTrafficPolicy.ts:116](https://github.com/Rucha0901/headlamp/blob/f19a5d7375f3a4adafc52bb2b8999455ae4eeca5/frontend/src/lib/k8s/backendTrafficPolicy.ts#L116)
...
Defined in: [lib/k8s/backendTrafficPolicy.ts:104](https://github.com/Rucha0901/headlamp/blob/f19a5d7375f3a4adafc52bb2b8999455ae4eeca5/frontend/src/lib/k8s/backendTrafficPolicy.ts#L104)
...
Defined in: [lib/k8s/backendTrafficPolicy.ts:108](https://github.com/Rucha0901/headlamp/blob/f19a5d7375f3a4adafc52bb2b8999455ae4eeca5/frontend/src/lib/k8s/backendTrafficPolicy.ts#L108)
...
Defined in: [lib/k8s/backendTrafficPolicy.ts:120](https://github.com/Rucha0901/headlamp/blob/f19a5d7375f3a4adafc52bb2b8999455ae4eeca5/frontend/src/lib/k8s/backendTrafficPolicy.ts#L120)
